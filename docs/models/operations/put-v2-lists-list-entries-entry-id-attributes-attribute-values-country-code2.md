...
```typescript
import { PutV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode2 } from "@interfere/attio/models/operations";

let value: PutV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode2 =
  "US";
