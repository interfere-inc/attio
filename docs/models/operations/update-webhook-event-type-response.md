...
```typescript
import { UpdateWebhookEventTypeResponse } from "@interfere/attio/models/operations";

let value: UpdateWebhookEventTypeResponse = "note.created";
