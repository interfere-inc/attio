...
```typescript
import { PutV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode1 } from "@interfere/attio/models/operations";

let value: PutV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode1 =
  "US";
