...
```typescript
import { GetV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode1 } from "@interfere/attio/models/operations";

let value: GetV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode1 =
  "US";
```
