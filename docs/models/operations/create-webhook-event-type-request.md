...
```typescript
import { CreateWebhookEventTypeRequest } from "@interfere/attio/models/operations";

let value: CreateWebhookEventTypeRequest = "note.created";
```
