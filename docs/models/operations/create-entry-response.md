...
```typescript
import { CreateEntryResponse } from "@interfere/attio/models/operations";

let value: CreateEntryResponse = {
  data: {
    id: {
...
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `data`                                                                                      | [operations.CreateEntryDataResponse](../../models/operations/create-entry-data-response.md) | :heavy_check_mark:                                                                          | N/A                                                                                         |