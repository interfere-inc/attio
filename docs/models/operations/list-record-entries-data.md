...
```typescript
import { ListRecordEntriesData } from "@interfere/attio/models/operations";

let value: ListRecordEntriesData = {
...
| `listApiSlug`                                                     | *string*                                                          | :heavy_check_mark:                                                | A human-readable slug for the list for use in URLs and responses. | enterprise_sales                                                  |
