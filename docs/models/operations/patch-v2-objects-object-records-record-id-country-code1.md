...
```typescript
import { PatchV2ObjectsObjectRecordsRecordIdCountryCode1 } from "@interfere/attio/models/operations";

let value: PatchV2ObjectsObjectRecordsRecordIdCountryCode1 = "US";
```
