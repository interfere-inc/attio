...
```typescript
import { PostV2ActivitiesActivityRecordsQueryCountryCode2 } from "@interfere/attio/models/operations";

let value: PostV2ActivitiesActivityRecordsQueryCountryCode2 = "US";
