...
```typescript
import { PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode1 } from "@interfere/attio/models/operations";

let value:
  PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode1 = "US";
