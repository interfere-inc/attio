...
### `operations.CreateNewAttributeDefaultValueDynamic`

```typescript
const value: operations.CreateNewAttributeDefaultValueDynamic = {
  type: "dynamic",
  template: "current-user",
};
```

### `operations.CreateNewAttributeDefaultValueStatic`

```typescript
const value: operations.CreateNewAttributeDefaultValueStatic = {
  type: "static",
  template: [
    {
      value: 5,
