...
```typescript
import { GetEntryResponse } from "@interfere/attio/models/operations";

let value: GetEntryResponse = {
  data: {
    id: {
...
| -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------- |
| `data`                                                               | [operations.GetEntryData](../../models/operations/get-entry-data.md) | :heavy_check_mark:                                                   | N/A                                                                  |