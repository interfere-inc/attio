...
```typescript
import { CreateRecordDataResponse } from "@interfere/attio/models/operations";

let value: CreateRecordDataResponse = {
  id: {
...
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| `id`                                                                                                | [operations.CreateRecordId](../../models/operations/create-record-id.md)                            | :heavy_check_mark:                                                                                  | N/A                                                                                                 |                                                                                                     |
...
| `values`                                                                                            | Record<string, *operations.CreateRecordValueUnion*[]>                                               | :heavy_check_mark:                                                                                  | A record type with an attribute `api_slug` as the key, and an array of value objects as the values. |                                                                                                     |