...
```typescript
import { UpdateWebhookEventTypeRequest } from "@interfere/attio/models/operations";

let value: UpdateWebhookEventTypeRequest = "note.created";
```
