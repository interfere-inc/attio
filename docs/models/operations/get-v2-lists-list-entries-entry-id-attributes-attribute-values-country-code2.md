...
```typescript
import { GetV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode2 } from "@interfere/attio/models/operations";

let value: GetV2ListsListEntriesEntryIdAttributesAttributeValuesCountryCode2 =
  "US";
```
