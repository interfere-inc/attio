...
```typescript
import { PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode2 } from "@interfere/attio/models/operations";

let value:
  PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode2 = "US";
