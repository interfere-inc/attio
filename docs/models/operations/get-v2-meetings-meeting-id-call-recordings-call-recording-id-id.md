...
```typescript
import { GetV2MeetingsMeetingIdCallRecordingsCallRecordingIdId } from "@interfere/attio/models/operations";

let value: GetV2MeetingsMeetingIdCallRecordingsCallRecordingIdId = {
