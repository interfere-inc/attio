...
```typescript
import { UpdateEntryResponse } from "@interfere/attio/models/operations";

let value: UpdateEntryResponse = {
  data: {
    id: {
...
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| `data`                                                                                      | [operations.UpdateEntryDataResponse](../../models/operations/update-entry-data-response.md) | :heavy_check_mark:                                                                          | N/A                                                                                         |