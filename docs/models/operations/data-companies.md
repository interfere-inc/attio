...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `id`                                                                               | [operations.SearchRecordsId3](../../models/operations/search-records-id3.md)       | :heavy_check_mark:                                                                 | N/A                                                                                |                                                                                    |
...
| `objectSlug`                                                                       | *"companies"*                                                                      | :heavy_check_mark:                                                                 | The slug of the object this record belongs to.                                     | companies                                                                          |
