...
```typescript
import { PostV2ActivitiesActivityRecordsQueryCountryCode1 } from "@interfere/attio/models/operations";

let value: PostV2ActivitiesActivityRecordsQueryCountryCode1 = "US";
