...
```typescript
import { GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode1 } from "@interfere/attio/models/operations";

let value:
  GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode1 = "US";
```
