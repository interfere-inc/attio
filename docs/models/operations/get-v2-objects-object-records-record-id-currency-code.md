...
```typescript
import { GetV2ObjectsObjectRecordsRecordIdCurrencyCode } from "@interfere/attio/models/operations";

let value: GetV2ObjectsObjectRecordsRecordIdCurrencyCode = "USD";
```
