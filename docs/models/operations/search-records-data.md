...
```typescript
import { SearchRecordsData } from "@interfere/attio/models/operations";

let value: SearchRecordsData = {
  id: {
...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `id`                                                                               | [operations.SearchRecordsId1](../../models/operations/search-records-id1.md)       | :heavy_check_mark:                                                                 | N/A                                                                                |                                                                                    |
