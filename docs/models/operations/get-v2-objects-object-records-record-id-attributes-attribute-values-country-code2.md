...
```typescript
import { GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode2 } from "@interfere/attio/models/operations";

let value:
  GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesCountryCode2 = "US";
```
