...
```typescript
import { GetV2ObjectsObjectRecordsRecordIdReferencedActorType } from "@interfere/attio/models/operations";

let value: GetV2ObjectsObjectRecordsRecordIdReferencedActorType =
  "workspace-member";
```
