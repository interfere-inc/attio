...
```typescript
import { PatchV2ObjectsObjectRecordsRecordIdCountryCode2 } from "@interfere/attio/models/operations";

let value: PatchV2ObjectsObjectRecordsRecordIdCountryCode2 = "US";
```
