...
| `comments`                                                                                                                                      | [models.Comment](../models/comment.md)[]                                                                                                        | :heavy_check_mark:                                                                                                                              | The requested page of comments in the thread, sorted by `created_at`, oldest first. Keep paginating for as long as a `next_cursor` is returned. |                                                                                                                                                 |