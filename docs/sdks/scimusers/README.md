...
<!-- UsageSnippet language="typescript" operationID="get_/scim/v2/Users" method="get" path="/scim/v2/Users" -->
```typescript
...
**Promise\<[operations.GetScimV2UsersResponse](../../models/operations/get-scim-v2-users-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="post_/scim/v2/Users" method="post" path="/scim/v2/Users" -->
```typescript
import { Attio } from "@interfere/attio";
...
**Promise\<[operations.PostScimV2UsersResponse](../../models/operations/post-scim-v2-users-response.md)\>**
