 ...
 */
export function scimUsersUpdate(
  client: AttioCore,
  request: operations.UpdateScimUserRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateScimUserResponse,
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UpdateScimUserRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateScimUserResponse$inboundSchema),
    M.json(204, operations.UpdateScimUserResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
