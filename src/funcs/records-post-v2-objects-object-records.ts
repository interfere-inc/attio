 ...
 */
export function recordsPostV2ObjectsObjectRecords(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PostV2ObjectsObjectRecordsNotFoundError
    | AttioError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors.PostV2ObjectsObjectRecordsNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
