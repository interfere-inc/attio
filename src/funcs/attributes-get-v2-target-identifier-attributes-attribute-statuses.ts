 ...
 */
export function attributesGetV2TargetIdentifierAttributesAttributeStatuses(
  client: AttioCore,
...
> {
  ...
  const context = {
    ...
    operationID:
      "get_/v2/{target}/{identifier}/attributes/{attribute}/statuses",
    oAuth2Scopes: null,
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .GetV2TargetIdentifierAttributesAttributeStatusesNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
