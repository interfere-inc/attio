 ...
 */
export function scimGroupsPatch(
  client: AttioCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PatchScimGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchScimGroupResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
