 ...
 */
export function entriesPatchV2ListsListEntriesEntryId(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PatchV2ListsListEntriesEntryIdImmutableValueError
    | errors.PatchV2ListsListEntriesEntryIdNotFoundError
    | AttioBaseError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.PatchV2ListsListEntriesEntryIdImmutableValueError$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.PatchV2ListsListEntriesEntryIdNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
