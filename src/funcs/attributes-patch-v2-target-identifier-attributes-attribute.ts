 ...
 */
export function attributesPatchV2TargetIdentifierAttributesAttribute(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PatchV2TargetIdentifierAttributesAttributeNotFoundError
    | AttioError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .PatchV2TargetIdentifierAttributesAttributeNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
