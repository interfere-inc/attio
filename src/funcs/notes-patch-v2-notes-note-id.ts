 ...
 */
export function notesPatchV2NotesNoteId(
  client: AttioCore,
  request: operations.PatchV2NotesNoteIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PatchV2NotesNoteIdResponse,
    | errors.PatchV2NotesNoteIdNotFoundError
    | errors.PatchV2NotesNoteIdValidationTypeError
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PatchV2NotesNoteIdRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "patch_/v2/notes/{note_id}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchV2NotesNoteIdResponse$inboundSchema),
    M.jsonErr(404, errors.PatchV2NotesNoteIdNotFoundError$inboundSchema),
    M.jsonErr(413, errors.PatchV2NotesNoteIdValidationTypeError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
