 ...
 */
export function attributesPostV2TargetIdentifierAttributesAttributeStatuses(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PostV2TargetIdentifierAttributesAttributeStatusesNotFoundError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .PostV2TargetIdentifierAttributesAttributeStatusesNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      409,
      errors
