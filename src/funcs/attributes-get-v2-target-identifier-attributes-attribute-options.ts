 ...
 */
export function attributesGetV2TargetIdentifierAttributesAttributeOptions(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.GetV2TargetIdentifierAttributesAttributeOptionsNotFoundError
    | AttioError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .GetV2TargetIdentifierAttributesAttributeOptionsNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
