 ...
 */
export function entriesGetV2ListsListEntriesEntryId(
  client: AttioCore,
  request: operations.GetV2ListsListEntriesEntryIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetV2ListsListEntriesEntryIdResponse,
    | errors.GetV2ListsListEntriesEntryIdNotFoundError
    | AttioError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetV2ListsListEntriesEntryIdRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_/v2/lists/{list}/entries/{entry_id}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetV2ListsListEntriesEntryIdResponse$inboundSchema),
    M.jsonErr(
      404,
      errors.GetV2ListsListEntriesEntryIdNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
