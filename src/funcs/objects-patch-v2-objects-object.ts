 ...
 */
export function objectsPatchV2ObjectsObject(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PatchV2ObjectsObjectNotFoundError
...
> {
  ...
  >(
    ...
    M.jsonErr(404, errors.PatchV2ObjectsObjectNotFoundError$inboundSchema),
