 ...
 */
export function listsPatchV2ListsList(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PatchV2ListsListValueNotFoundError
    | errors.PatchV2ListsListNotFoundError
    | AttioBaseError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.PatchV2ListsListValueNotFoundError$inboundSchema),
    M.jsonErr(404, errors.PatchV2ListsListNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
