 ...
 */
export function scimGroupsUpdate(
  client: AttioCore,
  request: operations.UpdateScimGroupRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateScimGroupResponse,
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.UpdateScimGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateScimGroupResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
