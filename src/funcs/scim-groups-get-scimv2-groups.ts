 ...
 */
export function scimGroupsGetSCIMV2Groups(
  client: AttioCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetScimV2GroupsResponse,
    | AttioBaseError
...
> {
  ...
  const context = {
    ...
    operationID: "get_/scim/v2/Groups",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScimV2GroupsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
