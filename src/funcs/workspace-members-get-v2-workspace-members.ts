 ...
 */
export function workspaceMembersGetV2WorkspaceMembers(
  client: AttioCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetV2WorkspaceMembersResponse,
    | AttioError
...
> {
  const path = pathToFunc("/v2/workspace_members")();
  ...
  const context = {
    ...
    operationID: "get_/v2/workspace_members",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetV2WorkspaceMembersResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
