 ...
 */
export function scimUsersPostSCIMV2Users(
  client: AttioCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostScimV2UsersResponse,
    | AttioBaseError
...
> {
  ...
  const context = {
    ...
    operationID: "post_/scim/v2/Users",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostScimV2UsersResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
