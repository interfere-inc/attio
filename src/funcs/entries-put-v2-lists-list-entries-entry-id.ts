...
export function entriesPutV2ListsListEntriesEntryId(
  ...
  Result<
    ...
    | errors.PutV2ListsListEntriesEntryIdImmutableValueError
    | errors.PutV2ListsListEntriesEntryIdNotFoundError
    | AttioError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors.PutV2ListsListEntriesEntryIdImmutableValueError$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.PutV2ListsListEntriesEntryIdNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
