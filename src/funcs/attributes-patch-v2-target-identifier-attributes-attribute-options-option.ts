 ...
 */
export function attributesPatchV2TargetIdentifierAttributesAttributeOptionsOption(
  client: AttioCore,
  request:
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .PatchV2TargetIdentifierAttributesAttributeOptionsOptionNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      409,
      errors
        .PatchV2TargetIdentifierAttributesAttributeOptionsOptionSlugConflictError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
