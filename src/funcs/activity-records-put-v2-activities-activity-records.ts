 ...
 */
export function activityRecordsPutV2ActivitiesActivityRecords(
  client: AttioCore,
  request: operations.PutV2ActivitiesActivityRecordsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PutV2ActivitiesActivityRecordsResponse,
    | errors.PutV2ActivitiesActivityRecordsBadRequestInvalidRequestError
    | errors.PutV2ActivitiesActivityRecordsAuthError
    | errors.PutV2ActivitiesActivityRecordsNotFoundError
    | errors.PutV2ActivitiesActivityRecordsConflictInvalidRequestError
    | AttioBaseError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PutV2ActivitiesActivityRecordsRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "put_/v2/activities/{activity}/records",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.PutV2ActivitiesActivityRecordsResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors
        .PutV2ActivitiesActivityRecordsBadRequestInvalidRequestError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors.PutV2ActivitiesActivityRecordsAuthError$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors.PutV2ActivitiesActivityRecordsNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      409,
      errors
        .PutV2ActivitiesActivityRecordsConflictInvalidRequestError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
