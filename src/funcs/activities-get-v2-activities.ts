 ...
 */
export function activitiesGetV2Activities(
  client: AttioCore,
  request?: operations.GetV2ActivitiesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetV2ActivitiesResponse,
    | AttioBaseError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetV2ActivitiesRequest$outboundSchema),
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_/v2/activities",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetV2ActivitiesResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
