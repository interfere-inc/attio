 ...
 */
export function webhooksPatchV2WebhooksWebhookId(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PatchV2WebhooksWebhookIdNotFoundError
    | AttioBaseError
...
> {
  ...
  >(
    ...
    M.jsonErr(404, errors.PatchV2WebhooksWebhookIdNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
