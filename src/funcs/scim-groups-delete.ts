 ...
 */
export function scimGroupsDelete(
  client: AttioCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeleteScimGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(204, operations.DeleteScimGroupResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
