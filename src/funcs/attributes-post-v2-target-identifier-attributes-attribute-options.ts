 ...
 */
export function attributesPostV2TargetIdentifierAttributesAttributeOptions(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PostV2TargetIdentifierAttributesAttributeOptionsNotFoundError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .PostV2TargetIdentifierAttributesAttributeOptionsNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      409,
      errors
