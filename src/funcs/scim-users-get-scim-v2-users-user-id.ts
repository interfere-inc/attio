 ...
 */
export function scimUsersGetScimV2UsersUserId(
  client: AttioCore,
  request: operations.GetScimV2UsersUserIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetScimV2UsersUserIdResponse,
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetScimV2UsersUserIdRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "get_/scim/v2/Users/{user_id}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScimV2UsersUserIdResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
