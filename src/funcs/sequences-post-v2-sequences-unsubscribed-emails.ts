 ...
 */
export function sequencesPostV2SequencesUnsubscribedEmails(
  client: AttioCore,
  request: operations.PostV2SequencesUnsubscribedEmailsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostV2SequencesUnsubscribedEmailsResponse,
    | errors.PostV2SequencesUnsubscribedEmailsValidationTypeError
    | AttioBaseError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PostV2SequencesUnsubscribedEmailsRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v2/sequences/unsubscribed_emails")();
  ...
  const context = {
    ...
    operationID: "post_/v2/sequences/unsubscribed_emails",
    oAuth2Scopes: null,
  ...
  >(
    M.json(
      200,
      operations.PostV2SequencesUnsubscribedEmailsResponse$inboundSchema,
    ),
    M.jsonErr(
      400,
      errors.PostV2SequencesUnsubscribedEmailsValidationTypeError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
