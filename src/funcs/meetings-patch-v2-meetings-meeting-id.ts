 ...
 */
export function meetingsPatchV2MeetingsMeetingId(
  client: AttioCore,
  request: operations.PatchV2MeetingsMeetingIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PatchV2MeetingsMeetingIdResponse,
    | errors.PatchV2MeetingsMeetingIdInvalidRequestError
    | errors.PatchV2MeetingsMeetingIdNotFoundError
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PatchV2MeetingsMeetingIdRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "patch_/v2/meetings/{meeting_id}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchV2MeetingsMeetingIdResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.PatchV2MeetingsMeetingIdInvalidRequestError$inboundSchema,
    ),
    M.jsonErr(404, errors.PatchV2MeetingsMeetingIdNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
