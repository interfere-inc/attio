 ...
 */
export function scimGroupsPostSCIMV2Groups(
  client: AttioCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostScimV2GroupsResponse,
    | AttioBaseError
...
> {
  ...
  const context = {
    ...
    operationID: "post_/scim/v2/Groups",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostScimV2GroupsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
