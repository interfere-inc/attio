 ...
 */
export function attributesPatchV2TargetIdentifierAttributesAttributeStatusesStatus(
  client: AttioCore,
  request:
  ...
  Result<
    ...
    | errors.PatchV2TargetIdentifierAttributesAttributeStatusesStatusNotFoundError
    | errors.PatchV2TargetIdentifierAttributesAttributeStatusesStatusSlugConflictError
    | AttioError
...
> {
  ...
  const pathParams = {
    ...
    status: encodeSimple("status", payload.status, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .PatchV2TargetIdentifierAttributesAttributeStatusesStatusNotFoundError$inboundSchema,
    ),
    M.jsonErr(
      409,
      errors
        .PatchV2TargetIdentifierAttributesAttributeStatusesStatusSlugConflictError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
