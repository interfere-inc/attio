 ...
 */
export function recordsGetV2ObjectsObjectRecordsRecordIdAttributesAttributeValues(
  client: AttioCore,
  request:
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors
        .GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
