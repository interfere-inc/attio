 ...
 */
export function objectsDeleteV2ObjectsObject(
  client: AttioCore,
  request: operations.DeleteV2ObjectsObjectRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteV2ObjectsObjectResponse,
    | errors.DeleteV2ObjectsObjectSystemEditUnauthorizedError
    | errors.DeleteV2ObjectsObjectAuthError
    | errors.DeleteV2ObjectsObjectNotFoundError
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteV2ObjectsObjectRequest$outboundSchema, value),
  ...
  const context = {
    ...
    operationID: "delete_/v2/objects/{object}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteV2ObjectsObjectResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.DeleteV2ObjectsObjectSystemEditUnauthorizedError$inboundSchema,
    ),
    M.jsonErr(403, errors.DeleteV2ObjectsObjectAuthError$inboundSchema),
    M.jsonErr(404, errors.DeleteV2ObjectsObjectNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
