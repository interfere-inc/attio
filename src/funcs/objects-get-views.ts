 ...
 */
export function objectsGetViews(
  client: AttioCore,
  request: operations.GetObjectViewsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetObjectViewsResponse,
    | errors.GetObjectViewsNotFoundError
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetObjectViewsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v2/objects/{object}/views")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetObjectViewsResponse$inboundSchema),
    M.jsonErr(404, errors.GetObjectViewsNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
