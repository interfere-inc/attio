 ...
 */
export function entriesPostV2ListsListEntriesQuery(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PostV2ListsListEntriesQueryNotFoundError
    | AttioBaseError
...
> {
  ...
  >(
    ...
    M.jsonErr(
      404,
      errors.PostV2ListsListEntriesQueryNotFoundError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
