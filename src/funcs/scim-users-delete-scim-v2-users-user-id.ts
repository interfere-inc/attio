 ...
 */
export function scimUsersDeleteScimV2UsersUserId(
  client: AttioCore,
  request: operations.DeleteScimV2UsersUserIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteScimV2UsersUserIdResponse,
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteScimV2UsersUserIdRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/scim/v2/Users/{user_id}")(pathParams);
  ...
  const context = {
    ...
    operationID: "delete_/scim/v2/Users/{user_id}",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(204, operations.DeleteScimV2UsersUserIdResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
