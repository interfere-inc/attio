 ...
 */
export function recordsPutV2ObjectsObjectRecordsRecordIdAttributesAttributeValues(
  client: AttioCore,
  request:
  ...
  Result<
    ...
    | errors.PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesBadRequestInvalidRequestError
    | errors.PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesAuthError
    | errors.PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesNotFoundInvalidRequestError
    | AttioBaseError
...
> {
  ...
  const context = {
    ...
    operationID:
      "put_/v2/objects/{object}/records/{record_id}/attributes/{attribute}/values",
    oAuth2Scopes: null,
  ...
  >(
    ...
    M.jsonErr(
      400,
      errors
        .PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesBadRequestInvalidRequestError$inboundSchema,
    ),
    M.jsonErr(
      403,
      errors
        .PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesAuthError$inboundSchema,
    ),
    M.jsonErr(
      404,
      errors
        .PutV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesNotFoundInvalidRequestError$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
