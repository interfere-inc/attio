 ...
 */
export function recordsPutV2ObjectsObjectRecords(
  client: AttioCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.PutV2ObjectsObjectRecordsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PutV2ObjectsObjectRecordsResponse$inboundSchema),
    M.jsonErr(
      400,
      errors.PutV2ObjectsObjectRecordsValueNotFoundError$inboundSchema,
    ),
    M.jsonErr(404, errors.PutV2ObjectsObjectRecordsNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
