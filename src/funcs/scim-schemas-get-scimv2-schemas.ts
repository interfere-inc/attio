 ...
 */
export function scimSchemasGetSCIMV2Schemas(
  client: AttioCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetScimV2SchemasResponse,
    | AttioBaseError
...
> {
  ...
  const context = {
    ...
    operationID: "get_/scim/v2/Schemas",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScimV2SchemasResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
