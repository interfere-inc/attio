 ...
 */
export function tasksPatchV2TasksTaskId(
  client: AttioCore,
  ...
  Result<
    ...
    | errors.PatchV2TasksTaskIdValidationTypeError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.PatchV2TasksTaskIdValidationTypeError$inboundSchema),
