...
export function attributesOptionsList(
  ...
  Result<
    operations.ListAttributeOptionsResponse,
    | errors.ListAttributeOptionsNotFoundError
    | AttioBaseError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.ListAttributeOptionsRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAttributeOptionsResponse$inboundSchema),
    M.jsonErr(404, errors.ListAttributeOptionsNotFoundError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
