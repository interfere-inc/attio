...
/** @internal */
export const ObjectId$inboundSchema: z.ZodMiniType<ObjectId, unknown> = z.pipe(
  z.object({
...
/** @internal */
export const ObjectT$inboundSchema: z.ZodMiniType<ObjectT, unknown> = z.pipe(
  z.object({
    id: z.lazy(() => ObjectId$inboundSchema),
    api_slug: types.nullable(types.string()),
    singular_noun: types.nullable(types.string()),
    plural_noun: types.nullable(types.string()),
