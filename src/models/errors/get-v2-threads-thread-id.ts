...
export type GetV2ThreadsThreadIdNotFoundErrorData = {
  statusCode: number;
  type: operations.GetV2ThreadsThreadIdType;
  code: operations.GetV2ThreadsThreadIdCode;
  message: string;
};
 ...
 * Not Found
 */
export class GetV2ThreadsThreadIdNotFoundError extends AttioBaseError {
  type: operations.GetV2ThreadsThreadIdType;
  code: operations.GetV2ThreadsThreadIdCode;
...
/** @internal */
export const GetV2ThreadsThreadIdNotFoundError$inboundSchema: z.ZodMiniType<
  GetV2ThreadsThreadIdNotFoundError,
  unknown
> = z.pipe(
  z.object({
    status_code: types.number(),
    type: operations.GetV2ThreadsThreadIdType$inboundSchema,
    code: operations.GetV2ThreadsThreadIdCode$inboundSchema,
