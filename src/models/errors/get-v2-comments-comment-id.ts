...
export type GetV2CommentsCommentIdNotFoundErrorData = {
  statusCode: number;
  type: operations.GetV2CommentsCommentIdType;
  code: operations.GetV2CommentsCommentIdCode;
  message: string;
};
 ...
 * Not Found
 */
export class GetV2CommentsCommentIdNotFoundError extends AttioBaseError {
  type: operations.GetV2CommentsCommentIdType;
  code: operations.GetV2CommentsCommentIdCode;
...
/** @internal */
export const GetV2CommentsCommentIdNotFoundError$inboundSchema: z.ZodMiniType<
  GetV2CommentsCommentIdNotFoundError,
  unknown
> = z.pipe(
  z.object({
    status_code: types.number(),
    type: operations.GetV2CommentsCommentIdType$inboundSchema,
    code: operations.GetV2CommentsCommentIdCode$inboundSchema,
