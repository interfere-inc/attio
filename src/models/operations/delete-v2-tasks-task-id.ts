...
/** @internal */
export const DeleteV2TasksTaskIdType$inboundSchema: z.ZodMiniEnum<
  typeof DeleteV2TasksTaskIdType
> = z.enum(DeleteV2TasksTaskIdType);

/** @internal */
export const DeleteV2TasksTaskIdCode$inboundSchema: z.ZodMiniEnum<
  typeof DeleteV2TasksTaskIdCode
> = z.enum(DeleteV2TasksTaskIdCode);
