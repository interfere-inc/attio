...
export const PostV2TasksNotFoundType = {
  InvalidRequestError: "invalid_request_error",
} as const;
export type PostV2TasksNotFoundType = ClosedEnum<
  typeof PostV2TasksNotFoundType
>;

export const PostV2TasksNotFoundCode = {
  NotFound: "not_found",
} as const;
export type PostV2TasksNotFoundCode = ClosedEnum<
  typeof PostV2TasksNotFoundCode
>;
...
/** @internal */
export const PostV2TasksNotFoundType$inboundSchema: z.ZodMiniEnum<
  typeof PostV2TasksNotFoundType
> = z.enum(PostV2TasksNotFoundType);

/** @internal */
export const PostV2TasksNotFoundCode$inboundSchema: z.ZodMiniEnum<
  typeof PostV2TasksNotFoundCode
> = z.enum(PostV2TasksNotFoundCode);
