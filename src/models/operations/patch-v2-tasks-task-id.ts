...
export const PatchV2TasksTaskIdBadRequestType = {
  InvalidRequestError: "invalid_request_error",
} as const;
export type PatchV2TasksTaskIdBadRequestType = ClosedEnum<
  typeof PatchV2TasksTaskIdBadRequestType
>;

export const PatchV2TasksTaskIdCodeValidationType = {
  ValidationType: "validation_type",
} as const;
export type PatchV2TasksTaskIdCodeValidationType = ClosedEnum<
  typeof PatchV2TasksTaskIdCodeValidationType
>;
...
/** @internal */
export const PatchV2TasksTaskIdBadRequestType$inboundSchema: z.ZodMiniEnum<
  typeof PatchV2TasksTaskIdBadRequestType
> = z.enum(PatchV2TasksTaskIdBadRequestType);

/** @internal */
export const PatchV2TasksTaskIdCodeValidationType$inboundSchema: z.ZodMiniEnum<
  typeof PatchV2TasksTaskIdCodeValidationType
> = z.enum(PatchV2TasksTaskIdCodeValidationType);
